...
def AdaBoost_Regressor(numOfRun,numOfFold,numOfEst,train_Data,test_Data,err_measure,ratio):
    ...
    ada_err = []
    ada_err.append(Common.errorMeasure(tr_y, pred_train_y,err_measure,ratio))
    ada_err.append(Common.errorMeasure(te_y, pred_test_y,err_measure,ratio))

    return (ada_err,best_numOfEst,cv_val_err,te_y,pred_test_y)
