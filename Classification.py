...
[train_label,test_label] = CommonClf.Label(tr_y,te_y,100)

# L2_Logistic Regression
#(LogL2_acc,best_lambda,val_acc,te_y,pred_test_y) = LogL2_Clf.LogisticL2_Clf(5,5,[1],tr_x,train_label,te_x,test_label,'recall')
#CommonClf.printResults(LogL2_acc,best_lambda,val_acc)
#CommonClf.plot_output(te_y,pred_test_y)

# random forest
(rfc_acc,best_para,val_acc,te_y,pred_test_y) = RF_Clf.RandomForest_Clf(5,5,100,[10,20,30,40,65],tr_x,train_label,te_x,test_label,'recall')
CommonClf.printResults(rfc_acc,best_para,val_acc)
CommonClf.plot_output(te_y,pred_test_y)
