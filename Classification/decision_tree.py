...
def decisionTreeClassification(X_val,Y_val,X_tra,Y_tra,regur,figure=False):
	...
	if figure is True:
		...
		clf.clf_accuracy(Y_val,result,'cnf')
		clf.AUC_Measure(Y_val,proba)
...
for lamb in [11]: # set a loop to choose best lambda for different versions
	error = [0,0]
