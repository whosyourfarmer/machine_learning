...
def printResults(error, best_para, val_err,train_err):
    print("Validation error of all models: ", val_err)
    print("Train_CV error of all models: ", train_err)
...
def errorMeasure(true_y,pred_y,err_measure='MAE',ratio=1):
    ...
    if (err_measure == 'Hits'):
        ...
        return 1 - total / size    # return the probability of not being on the top ratio%
