...
def LASSO_Regressor(numOfRun,numOfFold,LAMBDA,train_Data,test_Data,err_measure,ratio):
    ...
    lasso_err = []
    lasso_err.append(CommonReg.errorMeasure(tr_y, pred_train_y,err_measure,ratio))
    lasso_err.append(CommonReg.errorMeasure(te_y, pred_test_y,err_measure,ratio))


    return (lasso_err,best_alpha,cv_val_err,cv_train_err,te_y,pred_test_y)
