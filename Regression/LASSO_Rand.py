...
def LASSO_Regressor(numOfRun,numOfFold,LAMBDA,train_Data,test_Data,err_measure,ratio):
    ...
    for i in range(numOfIter):
        ...
        lasso_train_err.append(CommonReg.errorMeasure(tr_y, pred_train_y,err_measure,ratio))
        lasso_test_err.append(CommonReg.errorMeasure(te_y, pred_test_y,err_measure,ratio))

    lasso_err = [np.mean(lasso_train_err),np.mean(lasso_test_err)]
